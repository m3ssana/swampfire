...
> Detailed reference. Loaded on demand (read it when you need the full procedure) or via `/context add .kiro/steering/github-issues-workflow.md`. The concise mandatory rules live in `.kiro/steering/agent-instructions.md`.
